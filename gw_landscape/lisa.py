...
class LISA(Detector):
    ...
    def __init__(self, Tobs=4*YEAR, Larm=2.5e9, NC=2, transfer_file=Path(__file__).parent / 'R.txt'):
        """
    ...
    def frequencies(self):
        return np.logspace(np.log10(1.0e-5), np.log10(1.0e0), 1000)

    @property
    def psd(self):
        return self.Sn(self.frequencies)
